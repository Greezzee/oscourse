...
ASM_PFX(CallKernelThroughGateAsm):
    ...
    ; 9.8.5     . More detailed explanation why paging needs
...
AsmWithOurGdt:
    ...
    mov	ds, eax			; to all data segment registers
	mov	es, eax
	mov	fs, eax
	mov	gs, eax
	mov	ss, eax
    ...
    mov ecx,0xC0000080 ; reading IA32_EFER MSR
    rdmsr
    bts eax, 8
    bts eax, 11
    wrmsr
    ...
    ; LAB 2: Your code here:
    ; 4-level paging: PG=1, PAE=1, LME=1
    mov eax, cr0
    bts eax, 31
    mov cr0, eax
